...
export type PreloadDataQuery = {
  __typename?: "Query";
  allFarmOnboardings: Array<{
    __typename?: "FarmOnboarding";
    farmDomain?: string | null;
    values?: Array<{
 ...
 * });
 */
export function usePreloadDataQuery(
  baseOptions?: Apollo.QueryHookOptions<
    PreloadDataQuery,
    PreloadDataQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PreloadDataQuery, PreloadDataQueryVariables>(
    PreloadDataDocument,
    options
  );
}
export function usePreloadDataLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PreloadDataQuery, PreloadDataQueryVariables>(
    PreloadDataDocument,
    options
  );
}
export type PreloadDataQueryHookResult = ReturnType<typeof usePreloadDataQuery>;
export type PreloadDataLazyQueryHookResult = ReturnType<
  typeof usePreloadDataLazyQuery
>;
export type PreloadDataQueryResult = Apollo.QueryResult<
  PreloadDataQuery,
  PreloadDataQueryVariables
>;
