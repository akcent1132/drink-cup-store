 ...
 * });
 */
export function useNestedRowsQuery(
  baseOptions: Apollo.QueryHookOptions<
    NestedRowsQuery,
    NestedRowsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<NestedRowsQuery, NestedRowsQueryVariables>(
    NestedRowsDocument,
    options
  );
}
export function useNestedRowsLazyQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<NestedRowsQuery, NestedRowsQueryVariables>(
    NestedRowsDocument,
    options
  );
}
export type NestedRowsQueryHookResult = ReturnType<typeof useNestedRowsQuery>;
export type NestedRowsLazyQueryHookResult = ReturnType<
  typeof useNestedRowsLazyQuery
>;
export type NestedRowsQueryResult = Apollo.QueryResult<
  NestedRowsQuery,
  NestedRowsQueryVariables
>;
